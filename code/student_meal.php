    ...
    <div class="wrapper">
      ...
      <!-- Update Profile Modal ends -->
        ...
        <ul class="list-unstyled components">
          ...
          <li class="active">
            <a href="boot_meal_cancellation.php" class="text-light text-decoration-none"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="currentColor" class="bi bi-x-circle-fill mx-2" viewBox="0 0 16 16">
