    ...
    <div class="other-section">
        ...
        <div class="tab-content">
            ...
            <div id="inbox" class="tab-pane active jumbotron"><p></p>
                ...
                <div id="email_head"><h1 class="text-center">Write down the email: </h1></div>
                ...
                <form action="student_information.php" method="POST">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="email" class="form-control" id="email_form" aria-describedby="emailHelp" placeholder="Enter email of the student" name="stu_mail">
                    ...
                    <div class="text-center mt-5">
                        <button type="submit" class="btn btn-success btn-lg" id="submit_button" name="student_email_search">Submit</button>
                    </div>


                </form>

                <div class="card mx-auto" style="width: 22rem;" id="profile-card">

                  <div class="card-body">
                    <h5 class="card-title text-center" style="color:dodgerblue; font-size: 24px; font-weight: 700;">Student Profile</h5>
                    <h5 class="card-title"><?php searchDetailsOfTheStudent(); ?></h5>
